...
***
```{r}
formula <- ceb ~ urban*educ + age + electric + yearborn + agefbrth + knowmeth + agefm + heduc + spirit + protest + catholic + evermarr
...
#### The model's RMSE equals 1.57, i.e. on average the model is off by 1.57 "ever born children". Given the complex social, cultural and economic factors that influence fertility, the model has a moderate level of predictive accuracy, but also highlights important unexplained variation. The standard deviation of the dependent variable (ceb) is 2.31. This indicates that the model performs better than a naive baseline prediction that just guesses the mean number of ever born children for all observations.
